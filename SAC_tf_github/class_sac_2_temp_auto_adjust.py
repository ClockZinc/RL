...
class SAC(object):
    ...
    '''
    @tf.function
    def update_q_value(self,bs,ba,br,bs_,bd):
        ...
        with tf.GradientTape(persistent= True) as tape:         # 通过这种形式获得梯度信息
            ...
            td_error_1 = tf.losses.mean_squared_error(Q_value_1, target_Q_value)
            td_error_2 = tf.losses.mean_squared_error(Q_value_2, target_Q_value) # TD_error MSE(y,q)
    ...
    def learn(self):
        ...
        self.update_q_value(bs,ba,br,bs_,bd)
